...
async function test() {
  ...
  await UserFacade.addUser({ name: "kim-admin", userName: "kim@b.dk", password: "HemmeligtPassword1", role: "admin" })
  await UserFacade.addUser({ name: "ole", userName: "ole@b.dk", password: "HemmeligtPassword2", role: "user" })
